...
kmeans_model = joblib.load("SimpiaPiano_clustering.pkl")
tfidf_vectorizer = joblib.load("SimpiaPiano_tfidf_vectorizer.pkl")

# === Set Halaman ===
st.set_page_config(page_title="Topic Clustering - Simpia: Learn Piano Fast", layout="wide")

# === Judul Aplikasi dengan Emoji Piano ===
st.title("🎹 Topic Clustering - Simpia: Learn Piano Fast")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_simpia.csv",
                mime="text/csv"
            )
